...
export function Footer() {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-black ">
      <div className="w-full px-4 lg:px-0  text-white flex flex-col max-w-7xl mx-auto">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          ...
          <div className="w-44 pt-6 md:pt-0">
            <Link
              to={`/contact`}
              className="bg-indigo-500 hover:bg-indigo-600 justify-center text-center rounded shadow px-10 py-3 flex items-center"
            >
              Contact US
            </Link>
          </div>
        ...
        <div className="flex flex-col">
          <div className="flex mt-24 mb-12 flex-row justify-between items-center">
            ...
            <Link
              to={`/about`}
              className="hidden md:block cursor-pointer text-gray-600 hover:text-indigo-400 uppercase"
            >
              About
            </Link>
            <Link
